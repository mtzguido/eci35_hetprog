...
/////////////////////////////////////////////////////////////////
// MODULE add_array_pipes_sycl_c65e82_adaed5_sys
/////////////////////////////////////////////////////////////////
module add_array_pipes_sycl_c65e82_adaed5_sys
(
   input logic clock,
   ...
   // INST device_image_ip of add_array_pipes_sycl_c65e82_adaed5_di
   add_array_pipes_sycl_c65e82_adaed5_di device_image_ip
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      ...
      // AVM avm_mem_gmem0_DDR_port_0_0_rw
      .avm_mem_gmem0_DDR_port_0_0_rw_enable(avm_mem_gmem0_DDR_port_0_0_rw_enable),
      .avm_mem_gmem0_DDR_port_0_0_rw_read(avm_mem_gmem0_DDR_port_0_0_rw_read),
      .avm_mem_gmem0_DDR_port_0_0_rw_write(avm_mem_gmem0_DDR_port_0_0_rw_write),
      .avm_mem_gmem0_DDR_port_0_0_rw_address(avm_mem_gmem0_DDR_port_0_0_rw_address),
      .avm_mem_gmem0_DDR_port_0_0_rw_writedata(avm_mem_gmem0_DDR_port_0_0_rw_writedata),
      .avm_mem_gmem0_DDR_port_0_0_rw_byteenable(avm_mem_gmem0_DDR_port_0_0_rw_byteenable),
      .avm_mem_gmem0_DDR_port_0_0_rw_waitrequest(avm_mem_gmem0_DDR_port_0_0_rw_waitrequest),
      .avm_mem_gmem0_DDR_port_0_0_rw_readdata(avm_mem_gmem0_DDR_port_0_0_rw_readdata),
      .avm_mem_gmem0_DDR_port_0_0_rw_readdatavalid(avm_mem_gmem0_DDR_port_0_0_rw_readdatavalid),
      .avm_mem_gmem0_DDR_port_0_0_rw_burstcount(avm_mem_gmem0_DDR_port_0_0_rw_burstcount),
      .avm_mem_gmem0_DDR_port_0_0_rw_writeack(avm_mem_gmem0_DDR_port_0_0_rw_writeack),
      // AVM avm_mem_gmem0_DDR_port_1_0_rw
      .avm_mem_gmem0_DDR_port_1_0_rw_enable(avm_mem_gmem0_DDR_port_1_0_rw_enable),
      .avm_mem_gmem0_DDR_port_1_0_rw_read(avm_mem_gmem0_DDR_port_1_0_rw_read),
      .avm_mem_gmem0_DDR_port_1_0_rw_write(avm_mem_gmem0_DDR_port_1_0_rw_write),
      .avm_mem_gmem0_DDR_port_1_0_rw_address(avm_mem_gmem0_DDR_port_1_0_rw_address),
      .avm_mem_gmem0_DDR_port_1_0_rw_writedata(avm_mem_gmem0_DDR_port_1_0_rw_writedata),
      .avm_mem_gmem0_DDR_port_1_0_rw_byteenable(avm_mem_gmem0_DDR_port_1_0_rw_byteenable),
      .avm_mem_gmem0_DDR_port_1_0_rw_waitrequest(avm_mem_gmem0_DDR_port_1_0_rw_waitrequest),
      .avm_mem_gmem0_DDR_port_1_0_rw_readdata(avm_mem_gmem0_DDR_port_1_0_rw_readdata),
      .avm_mem_gmem0_DDR_port_1_0_rw_readdatavalid(avm_mem_gmem0_DDR_port_1_0_rw_readdatavalid),
      .avm_mem_gmem0_DDR_port_1_0_rw_burstcount(avm_mem_gmem0_DDR_port_1_0_rw_burstcount),
      .avm_mem_gmem0_DDR_port_1_0_rw_writeack(avm_mem_gmem0_DDR_port_1_0_rw_writeack),
      // AVS csr_ring_root_avs
