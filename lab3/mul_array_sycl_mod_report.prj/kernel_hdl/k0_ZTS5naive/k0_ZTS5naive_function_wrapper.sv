...
module k0_ZTS5naive_function_wrapper (
    input wire [511:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_readdata,
    input wire [0:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_readdatavalid,
    input wire [0:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_waitrequest,
    input wire [0:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_writeack,
    ...
    output wire [34:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_address,
    output wire [4:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_burstcount,
    output wire [63:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_byteenable,
    output wire [0:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_enable,
    output wire [0:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_read,
    output wire [0:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_write,
    output wire [511:0] avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_writedata,
    ...
    wire [34:0] k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_address;
    wire [4:0] k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_burstcount;
    wire [63:0] k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_byteenable;
    wire [0:0] k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_enable;
    wire [0:0] k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_read;
    wire [0:0] k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_write;
    wire [511:0] k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_writedata;
    ...
    // k0_ZTS5naive_function_aunroll_x(BLACKBOX,99)
    k0_ZTS5naive_function thek0_ZTS5naive_function_aunroll_x (
        ...
        .in_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_readdata(avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_readdata),
        .in_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_readdatavalid(avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_readdatavalid),
        .in_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_waitrequest(avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_waitrequest),
        .in_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_writeack(avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_writeack),
        ...
        .out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_address(k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_address),
        .out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_burstcount(k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_burstcount),
        .out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_byteenable(k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_byteenable),
        .out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_enable(k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_enable),
        .out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_read(k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_read),
        .out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_write(k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_write),
        .out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_writedata(k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_writedata),
    ...
    // avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_address(GPOUT,79)
    assign avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_address = k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_address;

    // avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_burstcount(GPOUT,80)
    assign avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_burstcount = k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_burstcount;

    // avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_byteenable(GPOUT,81)
    assign avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_byteenable = k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_byteenable;

    // avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_enable(GPOUT,82)
    assign avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_enable = k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_enable;

    // avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_read(GPOUT,83)
    assign avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_read = k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_read;

    // avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_write(GPOUT,84)
    assign avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_write = k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_write;

    // avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_writedata(GPOUT,85)
    assign avm_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_writedata = k0_ZTS5naive_function_aunroll_x_out_memcoalesce_load_ZTS5naive_fpgaunique_0_k0_ZTS5naive_avm_writedata;

    // avm_memdep_k0_ZTS5naive_address(GPOUT,86)
    assign avm_memdep_k0_ZTS5naive_address = k0_ZTS5naive_function_aunroll_x_out_memdep_k0_ZTS5naive_avm_address;

    // avm_memdep_k0_ZTS5naive_burstcount(GPOUT,87)
    assign avm_memdep_k0_ZTS5naive_burstcount = k0_ZTS5naive_function_aunroll_x_out_memdep_k0_ZTS5naive_avm_burstcount;

    // avm_memdep_k0_ZTS5naive_byteenable(GPOUT,88)
    assign avm_memdep_k0_ZTS5naive_byteenable = k0_ZTS5naive_function_aunroll_x_out_memdep_k0_ZTS5naive_avm_byteenable;

    // avm_memdep_k0_ZTS5naive_enable(GPOUT,89)
    assign avm_memdep_k0_ZTS5naive_enable = k0_ZTS5naive_function_aunroll_x_out_memdep_k0_ZTS5naive_avm_enable;

    // avm_memdep_k0_ZTS5naive_read(GPOUT,90)
    assign avm_memdep_k0_ZTS5naive_read = k0_ZTS5naive_function_aunroll_x_out_memdep_k0_ZTS5naive_avm_read;

    // avm_memdep_k0_ZTS5naive_write(GPOUT,91)
    assign avm_memdep_k0_ZTS5naive_write = k0_ZTS5naive_function_aunroll_x_out_memdep_k0_ZTS5naive_avm_write;

    // avm_memdep_k0_ZTS5naive_writedata(GPOUT,92)
